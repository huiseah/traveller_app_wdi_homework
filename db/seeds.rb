...
c1 = Coffeeshop.create(:name => 'Altar Lounge', :address => '1/195 Bondi Rd
Bondi NSW')
c2 = Coffeeshop.create(:name => 'The Wholefood Cafe', :address => '225 Bondi Rd
Bondi NSW')
c3 = Coffeeshop.create(:name => 'The Flying Squirrel', :address => '249 Bondi Rd
Bondi NSW')
